...
export class DataService {
    ...
    enhanced.indicators = {
      ...
      timeframeData: {
        ...
        '5d': {
          spy: {
            ...data.indicators.spy,
            change: data.indicators.spy.change * 2.1,
          },
          qqq: {
            ...data.indicators.qqq,
            change: data.indicators.qqq.change * 1.8,
          },
          iwm: {
            ...data.indicators.iwm,
            change: data.indicators.iwm.change * 2.3,
          },
          vix: {
            ...data.indicators.vix,
            value: data.indicators.vix.value * 1.2,
          },
        },
        '1m': {
          spy: {
            ...data.indicators.spy,
            change: data.indicators.spy.change * 4.2,
          },
          qqq: {
            ...data.indicators.qqq,
            change: data.indicators.qqq.change * 3.8,
          },
          iwm: {
            ...data.indicators.iwm,
            change: data.indicators.iwm.change * 4.1,
          },
          vix: {
            ...data.indicators.vix,
            value: data.indicators.vix.value * 0.8,
          },
        },
      },
    } as any;
  ...
  static getIndicatorForTimeframe(
    data: SentimentData,
    timeframe: string,
    indicator: string,
  ): any {
    ...
    return {
      overall: {
        ...
        components: {
          ...
          volatility: { score: 50, weight: 0.2 },
          options: { score: 50, weight: 0.2 },
        },
      },
      timeframes: {
        '1d': {
